              ...
              <div class="row my-4">
                ...
                <div class="col-md-12">
                  <div class="card shadow">
                    <div class="card-body">
                    <a href="<?=site_url('c_ask_form/tambah');?>" class="btn btn-primary mb-3">Tambah</a>
                      <!-- table -->
                      ...
                      <thead class="thead-dark">
                        ...
                        <?php
                         ...
                         <td><?= $a['ask_form_st']; ?></td>
                         <td>
                         <a class="dropdown-item" href="<?= site_url("c_ask_form/edit/{$a['ask_form_id']}"); ?>">Edit</a> 
                         <form method="POST" action="<?= site_url("c_ask_form/hapus_data/{$a['ask_form_id']}"); ?>" class="mx-1 my-1">
                         <form method="POST" action="<?= site_url("c_ask_form/hapus_data/{$a['ask_form_id']}"); ?>" class="mx-1 my-1">
